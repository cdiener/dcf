...
const std::map<char, int> AAmap = { {'I',0},{'L',1},{'W',2},{'F',3},{'V',4},{'M',5},{'Y',6},{'A',7},{'P',8},{'T',9},{'S',10}, \
					{'C',11},{'G',12},{'N',13},{'D',14},{'Q',15},{'E',16},{'H',17},{'K',18},{'R',19} };

/**
Some hydrophobicity scales. Eisenberg is taken from Eisenberg. et. al. and
CCS is taken from Tossi. et. al.
*/
const double eisenberg[] = { 0.73, 0.53, 0.37, 0.61, 0.54, 0.26, 0.02, 0.25, -0.07, -0.18, -0.26, 0.04, 0.16, -0.64, \
			 -0.72, -0.69, -0.62, -0.40, -1.10, -1.76 };

const double CCS[] = { 8.7, 9.7, 9.7, 10.0, 4.1, 4.6, 2.5, -1.1, -0.2, -3.8, -4.3, -2.3, -2.4, -7.1, -8.3, -6.0, \
			-8.3, -3.8, -9.9, -10.0};
...
*/
const double logP_coef[] = {-3.25, 0.7, 0.8, 1.47, 1.16, 0.32, 0.51, 0.55, -0.27, 0.15, -0.26, -0.45, 0.83, -0.22, -0.98, \
				-0.28, -1.0, -0.34, -0.31, 0.17, -0.79};
