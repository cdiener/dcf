...
const double E_c = 0.05;	// The largest competing energy difference that we still 
							// want to accept in the beginning of optimization
const double ELP = 1.5; 	// Factor how strong the EP should influence the energy 
							// values (0-none, 1-as much as the energy values) 
